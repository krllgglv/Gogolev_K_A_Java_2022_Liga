...
import ru.digitalleague.gogolev.commands.commands_for_entities.parametrized.DeleteTaskCommand;
...
public class DeleteCommandFactory implements ParametrizedCommandsAbstractFactory {
    ...
    public Command<?> create(String... input) {
        ...
        return new DeleteTaskCommand(usersService, tasksService, validatedParameters);
    }
